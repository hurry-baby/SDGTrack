...
from dataset.SDGTrack import create_dataloader
...
def train(hyp, opt, device, tb_writer=None):
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        mloss = torch.zeros(6, device=device)  # mean losses 改...............
        if rank != -1:
            dataloader.sampler.set_epoch(epoch)
        pbar = enumerate(dataloader)
        logger.info(('\n' + '%10s' * 10) % ('Epoch', 'gpu_mem', 'GIoU','idloss', 'obj','ttcloss','l2loss', 'total', 'targets', 'lr'))
        if rank in [-1, 0]:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--hyp', type=str, default='../experiments/train/SDGTrack.yaml', help='hyperparameters path, i.e. data/hyp.scratch.yaml')
